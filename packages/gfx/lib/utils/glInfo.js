...
export class glInfo {
    constructor(gl) {
        ...
        this.renderer = glRenderInfo && gl.getParameter(glRenderInfo.UNMASKED_RENDERER_WEBGL) ? gl.getParameter(glRenderInfo.UNMASKED_RENDERER_WEBGL) : "unknown";
        this.vendor = glRenderInfo && gl.getParameter(glRenderInfo.UNMASKED_VENDOR_WEBGL) ? gl.getParameter(glRenderInfo.UNMASKED_VENDOR_WEBGL) : "unknown";
