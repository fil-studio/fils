...
Fil's command line utils for internal studio use.

## Available commands
This is a super early stage of the libary. Currently available commands:

`fil init <folder_name>`: Inits empty boilerplate project at specified folder.
